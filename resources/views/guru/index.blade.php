...
@endif
    ...
    <p style="color: white;">Anda dapat mengelola data siswa, guru, dan data pelajaran dengan mudah di sini.</p>
                                ...
                                @endif
                                <a href="{{ route('guru1.create') }}" class="btn btn-md btn-info mb-3" style="background-color: #006e90; color: white;">
    <i class="fas fa-plus"></i> TAMBAH DATA GURU
                                ...
                                <table id="dataTable" class="display text-primary" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="color: white;">NIP</th>
                                            <th scope="col" style="color: white;">Nama Guru</th>
                                            <th scope="col" style="color: white;">Mengajar Kelas</th>
                                            <th scope="col" style="color: white;">Alamat Guru</th>
                                            <th scope="col" style="color: white;">Nomor Handphone Guru</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">{{ $guru->kelas_diajar }}</td>
                                            <td style="text-align: center;">{{ $guru->alamat }}</td>
                                            <td style="text-align: center;">{{ $guru->no_hp }}</td>
