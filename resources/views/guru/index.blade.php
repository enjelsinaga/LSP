                    ...
                    <div class="col-md-12">
                        <div class="card border-0 shadow rounded">
                            <div class="card-body">
                                ...
                                @endif
                                <a href="{{ route('guru1.create') }}" class="btn btn-md btn-info mb-3">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="text-align: center;">Mengajar Kelas</th>
                                            <th scope="col" style="text-align: center;">Alamat Guru</th>
                                            <th scope="col" style="text-align: center;">Nomor Handphone Guru</th>
