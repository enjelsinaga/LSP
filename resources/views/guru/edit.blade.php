                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <form action="{{ route('guru1.update', $data->id) }}" method="post"
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Mengajar Kelas</label>
                                <input type="varchar" class="form-control @error('kelas_diajar') is-invalid @enderror"
                                    name="kelas_diajar" placeholder="Kelas yang diajar" value="{{ $data->kelas_diajar }}">
                                @error('kelas_diajar')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="varchar" class="form-control @error('alamat') is-invalid @enderror"
                                    name="alamat" placeholder="Alamat Guru" value="{{ $data->alamat }}">
                                @error('alamat')
                                <div class="alert alert-danger mt-2">
                                    {{ $message }}
                                </div>
