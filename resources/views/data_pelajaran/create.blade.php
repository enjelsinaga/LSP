...
<head>
    ...
    width: 100%; /* Atau set nilai yang diinginkan */
    max-width: none; /* Ini untuk mengabaikan batasan max-width bawaan jika ada */
}
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('data_pelajaran.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kelas_ajaran') is-invalid @enderror" name="kelas_ajaran">
                                    <option value="" selected disabled>Kelas Ajaran</option>
