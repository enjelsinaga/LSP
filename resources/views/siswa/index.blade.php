...
@endif
    ...
    <p style="color: white;">Anda dapat mengelola data siswa, guru, dan data pelajaran dengan mudah di sini.</p>
                                ...
                                @endif
                                <a href="{{ route('siswa.create') }}" class="btn btn-md btn-info mb-3" style="background-color: #006e90; color: white;">
...
<table id="dataTable" class="display text-primary" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style="color: white;">Kelas Siswa</th>
                                            <th scope="col" style="color: white;">Gender Siswa</th>
                                            <th scope="col" style="color: white;">Alamat Siswa</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('siswa.destroy', $siswa->id) }}" method="post">
                                                    <a href="{{ route('siswa.edit', $siswa->id) }}" class="btn btn-sm btn-primary">
